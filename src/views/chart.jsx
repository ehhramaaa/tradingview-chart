...
const chart = () => {
    ...
    useEffect(() => {
        // Memulihkan konfigurasi dari local storage jika tersedia
        const savedConfig = JSON.parse(localStorage.getItem('chartConfig'));
        const finalConfig = savedConfig || chartConfig;
        ...
        // Menyimpan konfigurasi ke local storage
        localStorage.setItem('chartConfig', JSON.stringify(finalConfig));
